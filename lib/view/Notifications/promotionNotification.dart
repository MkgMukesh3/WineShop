...
class PromotionNotification extends StatefulWidget {
  const PromotionNotification({super.key});

  @override
  State<PromotionNotification> createState() => _PromotionNotificationState();
}

class _PromotionNotificationState extends State<PromotionNotification> {
  @override
